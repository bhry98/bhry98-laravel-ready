...
return [
    ...
    "registration-success" => "Registration successfully please login",
    "registration-failed" => "Field registration",
    ...
    "reset-password-send" => "Reset password code send successfully",
    "reset-password-failed" => "Reset password code send failed",
    ...
    "otp-verified-field" => "OTP verified failed",
