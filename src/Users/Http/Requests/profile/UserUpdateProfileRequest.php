...
class UserUpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $roles["username"] = [
            "sometimes",
            "string",
            "unique:" . UsersCoreModel::TABLE_NAME . ",username," . $authId,
        ];
        $roles["first_name"] = [
            "sometimes",
            "string",
        ...
        $roles["email"] = [
            "sometimes",
            "email",
            "unique:" . UsersCoreModel::TABLE_NAME . ",email," . $authId,
        ];
        $roles["phone_number"] = [
            "sometimes",
            "numeric",
            ...
            "unique:" . UsersCoreModel::TABLE_NAME . ",phone_number,".$authId,
        ];
        $roles["birthdate"] = [
            "sometimes",
            "nullable",
        ...
        $roles["national_id"] = [
            ...
            "numeric",
            "digits:14",
            "unique:" . UsersCoreModel::TABLE_NAME . ",national_id," . $authId,
        ];
        $roles["country"] = [
            "sometimes",
            "nullable",
